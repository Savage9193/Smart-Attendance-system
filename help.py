...
class Help:
    def __init__(self,root):
        ...
        img_top = Image.open(r"D:\Face reacogniton system\college_images\HELP2.jpeg")
        ...
        dev_label=Label(first_label,text="Email:tyagishahvezz551@gamil.com",font=("times new roman",20,"bold"),bg="white",fg="blue")
