...
class Attendance:
    def __init__(self,root):
        ...
        # first Image
        img=Image.open(r"D:\Face reacogniton system\college_images\smart-attendance.jpg")
        ...
        # second image
        img1=Image.open(r"D:\Face reacogniton system\college_images\st1.jpg")
        ...
        # Title
        title_label=Label(bg_img,text="ATTENDANCE MANAGEMENT SYSTEM",font=("items new roman",35,"bold"),bg="white",fg="darkgreen")
        ...
        img_left=Image.open(r"D:\Face reacogniton system\college_images\face-recognition.png")
        ...
        attendance_entry = ttk.Entry(left_inside_frame, textvariable=self.var_atten_id ,width=20, font=("times new roman", 13, "bold"))
        ...
        Rollentry = ttk.Entry(left_inside_frame, width=20, textvariable=self.var_atten_roll, font=("times new roman", 13, "bold"))
        ...
        dateentry = ttk.Entry(left_inside_frame, width=20, textvariable=self.var_atten_date, font=("times new roman", 13, "bold"))
        dateentry.grid(row=1, column=3, padx=10, pady=5, sticky=W)
        ...
        timeentry = ttk.Entry(left_inside_frame, width=20, textvariable=self.var_atten_time, font=("times new roman", 13, "bold"))
        ...
        depentry = ttk.Entry(left_inside_frame, width=20, textvariable=self.var_atten_dep, font=("times new roman", 13, "bold"))
        depentry.grid(row=2, column=3, padx=10, pady=5, sticky=W)
        ...
        self.atten_status = ttk.Combobox(left_inside_frame, font=("times new roman", 12, "bold"), textvariable=self.var_atten_attendance, state="readonly", width=20)
        ...
        # dlt_btn=Button(btn_frame,text="Update",width=17,font=("times new roman",13,"bold"),bg="blue",fg="white")
