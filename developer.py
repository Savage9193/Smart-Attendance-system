...
class Developer:
    def __init__(self,root):
        ...
        img_top = Image.open(r"D:\Face reacogniton system\college_images\dev.jpg")
        ...
        img_top1= Image.open(r"D:\Face reacogniton system\college_images\shahvez.jpg")
        ...
        dev_label=Label(main_frame,text="Hello my name is shahvez",font=("times new roman",20,"bold"),bg="white",fg="blue")
        ...
        img2=Image.open(r"D:\Face reacogniton system\college_images\dev2.jpg")
